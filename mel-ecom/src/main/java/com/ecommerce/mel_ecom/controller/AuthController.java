...
import com.ecommerce.mel_ecom.security.request.SignupRequest;
import com.ecommerce.mel_ecom.security.response.MessageResponse;
import com.ecommerce.mel_ecom.security.response.UserInfoResponse;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signupRequest) {
        ...
        if (userRepository.existsByEmail(signupRequest.getEmail())) {
            return ResponseEntity
                    .badRequest()
                    .body(new MessageResponse("Error: Email is already associated with an existing account!"));
        }
